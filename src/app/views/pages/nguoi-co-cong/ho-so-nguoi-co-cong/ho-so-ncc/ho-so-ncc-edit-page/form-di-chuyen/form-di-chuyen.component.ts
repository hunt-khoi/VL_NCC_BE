...
@Component({
	selector: 'kt-form-di-chuyen',
	templateUrl: './form-di-chuyen.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class FormDiChuyenComponent implements OnInit {
	data: any;
	...
	addTC() {
		...
		for (var i=0; i<this.listLoaiTroCap.length; i++) {
			...
			//dùng chung tất cả
			if (item.id == 23) { //hàng tháng 1, 2, 3, 4, 9, 10, 11, 13, 14, 15, 17, 18, 19, 21, 22, 23
				instance.data = {
