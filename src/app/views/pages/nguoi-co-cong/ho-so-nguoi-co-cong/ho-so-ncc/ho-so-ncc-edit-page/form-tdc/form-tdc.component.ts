...
@Component({
	selector: 'kt-form-tdc',
	templateUrl: './form-tdc.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class FormTDCComponent extends FormBaseComponent implements OnInit, OnDestroy {
