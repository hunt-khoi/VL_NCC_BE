...
export class FormCatTC_MTP_TuatComponent extends FormBaseComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		this.createForm();
		this.loadLoaiTC([19, 20, 26, 24, 23]);
	}
	...
	createForm() {
		const temp: any = this.buildBaseForm(this.item);
