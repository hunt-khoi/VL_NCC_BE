...
@Component({
	selector: 'kt-form-cat-tc-2ls',
	templateUrl: './form-cat-tc-2ls.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class FormCatTC_2LietSyComponent extends FormBaseComponent implements OnInit {
	data: any;
