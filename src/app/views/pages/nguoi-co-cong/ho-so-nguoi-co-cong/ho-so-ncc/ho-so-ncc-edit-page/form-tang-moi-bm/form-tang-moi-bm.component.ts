...
export class FormTangMoiBMComponent extends FormBaseComponent implements OnInit, OnDestroy {
	...
	addCanCuLS() {
		this.commonService.liteQHGiaDinhNCC().pipe(takeUntil(this.destroy$)).subscribe(res => {
