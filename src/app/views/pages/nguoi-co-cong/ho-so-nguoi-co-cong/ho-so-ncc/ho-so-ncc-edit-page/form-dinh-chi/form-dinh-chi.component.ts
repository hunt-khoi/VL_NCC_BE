...
@Component({
	selector: 'kt-form-dinh-chi',
	templateUrl: './form-dinh-chi.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class FormDinhChiComponent extends FormBaseComponent implements OnInit {
	data: any;
		...
		for (var i=0; i<this.listLoaiTroCap.length; i++) {
			...
			if (item.id == 23) { //hàng tháng
				instance.data = {
					...
					showCat: true,
					showNgayCat: true,
					showDinhChiLyDo: true,
					isTienDCTruyThu: true,
				};
			}
