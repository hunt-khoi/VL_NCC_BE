...
export class DoiTuongBaoHiemListComponent implements OnInit {
	...
	ngOnInit() {
		...
		// Init DataSource
		this.dataSource = new DoiTuongBaoHiemDataSource(this.apiService);
		let queryParams = new QueryParamsModel({});
		this.route.queryParams.subscribe(_ => {
			if (this.dataSource) {
				queryParams = this.apiService.lastFilterBH$.getValue();
	...
	Edit(_item: DoiTuongBHYTModel, allowEdit: boolean = true) {
	...
	Lock(item: DoiTuongBHYTModel, value: boolean = false) {
