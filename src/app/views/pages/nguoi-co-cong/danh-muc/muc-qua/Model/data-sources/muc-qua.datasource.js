...
exports.MucQuaDataSource = void 0;
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var crud_1 = require("../../../../../../../core/_base/crud");
var MucQuaDataSource = /** @class */ (function (_super) {
    __extends(MucQuaDataSource, _super);
    function MucQuaDataSource(dienChinhHinhService) {
        var _this = _super.call(this) || this;
        _this.dienChinhHinhService = dienChinhHinhService;
        return _this;
    }
    MucQuaDataSource.prototype.loadList = function (queryParams) {
        var _this = this;
        ...
        this.dienChinhHinhService.findData(queryParams)
            ...
            _this.dienChinhHinhService.ReadOnlyControl = res.Visible;
        });
    };
    return MucQuaDataSource;
}(crud_1.BaseDataSource));
exports.MucQuaDataSource = MucQuaDataSource;
//# sourceMappingURL=muc-qua.datasource.js.map