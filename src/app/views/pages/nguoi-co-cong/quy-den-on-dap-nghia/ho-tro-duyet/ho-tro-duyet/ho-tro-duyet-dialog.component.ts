...
@Component({
	selector: 'kt-ho-tro-duyet-dialog',
	templateUrl: './ho-tro-duyet-dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class HoTroDTDuyetDialogComponent implements OnInit {
	item: any;
	itemForm: FormGroup;
	hasFormErrors = false;
	viewLoading = false;
	...
	constructor(
		public dialogRef: MatDialogRef<HoTroDTDuyetDialogComponent>,
		...
		private translate: TranslateService) {
			this._NAME = 'Danh sách đối tượng hỗ trợ';
			// load id user
	...
	onSubmit(value: boolean) {
		...
		if (value) {
			...
			// this.CommonService.getIdHuongDan(this.item.Id).subscribe(res1 => {
