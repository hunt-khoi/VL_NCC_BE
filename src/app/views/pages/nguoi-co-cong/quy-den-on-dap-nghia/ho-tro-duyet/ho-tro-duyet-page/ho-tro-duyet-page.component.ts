...
@Component({
	selector: 'kt-ho-tro-duyet-page',
	templateUrl: './ho-tro-duyet-page.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class HoTroDTDuyetPageComponent implements OnInit {
	...
	HoTro() {
		let _item = this.item;
		let allowEdit = true;
		let soTien = this.TongTien
		const dialogRef = this.dialog.open(HoTroSupDialogComponent, { data: { _item, allowEdit, soTien } });
		dialogRef.afterClosed().subscribe(res => {
			if (!res) {
			} else {
