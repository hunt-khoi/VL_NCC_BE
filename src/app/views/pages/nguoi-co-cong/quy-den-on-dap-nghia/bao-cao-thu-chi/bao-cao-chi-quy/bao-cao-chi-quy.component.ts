...
@Component({
	selector: 'm-bao-cao-chi-quy',
	templateUrl: './bao-cao-chi-quy.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
})

export class BaoCaoChiQuyComponent implements OnInit {
	...
	constructor(public tracuuHoSoService: BaoCaoThuChiService,
		...
		private translate: TranslateService) {
			...
			this._name = this.translate.instant("Báo cáo chi quỹ");
	}
	...
	loadData() {
		...
		this.display = false;
		this.tracuuHoSoService.baoCaoChiQuy(this.queryParams, this.loaitk).subscribe(res => {
	...
	xuatDanhSach() {
		...
		this.tracuuHoSoService.exportBCChiQuy(this.queryParams, this.loaitk).subscribe(res => {
			this.loadingSubject.next(false);
