...
@Component({
	selector: 'kt-ho-so-nha-o-duyet',
	templateUrl: './ho-so-nha-o-duyet-dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
})

export class HoSoNhaODuyetDialogComponent implements OnInit {
	item: any;
	itemForm: FormGroup;
	hasFormErrors = false;
	viewLoading = false;
	...
	constructor(
		public dialogRef: MatDialogRef<HoSoNhaODuyetDialogComponent>,
