...
import { BaseDataSource, QueryParamsModel, QueryResultsModel, LayoutUtilsService } from '../../../../../core/_base/crud';
import { CommonService } from '../../services/common.service';

export class ChonNhieuBieuMauListDataSource extends BaseDataSource {
	...
	loadList_Emp(queryParams: QueryParamsModel) {
		...
		this.service.findData_BieuMau(queryParams)
			.pipe(
