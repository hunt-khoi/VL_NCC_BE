...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		constants: {
			title:'Hệ thống CSDL Sở Lao động - Thương bình và Xã hội',
			favicon: './assets/media/logos/favicon.ico',
			logo: './assets/images/logo.png',
			phone:'18008000-N6',
			email:'cskhdn@viettel.com.vn',
			license:'2019 © Copyright Tổng công ty Giải pháp doanh nghiệp Viettel (VTS)',
			background:'./assets/images/bg_login.png',
			background_header: './assets/images/bgHeader.png'
		}
	};
